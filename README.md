...
1. Git clone ````https://github.com/ksenia1234567890/l3.2````
...
* Вторая кнопка ````Добавить запись```` перекидывает на окно с стремя строчками ввода «Фамилия», «Имя», 
«Отчество» и кнопкой «Сохранить запись».
* Третья кнопка ````Обновить последнюю запись```` меняет в списке данных «ФИО» на Иванов Иван 
Иванович.
